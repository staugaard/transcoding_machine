require 'right_aws'
require 'transcoding_machine/s3_storage'
...
module TranscodingMachine
  class Queue
    def initialize
      ...
      TranscodingMachine::Transcoder.options[:storage] = TranscodingMachine::S3Storage.new
    end
